<template>
  <div class="container-btn-export">
      <button
            ...
            title="Export shown list of territories into Excel file."
            @click="downloadExcel"
        >
    ...
    methods: {
        async downloadExcel(){
            ...
            try {
                ...
                let downloadUrl = '/territories/export-excel';
				...
				let result = await this.$axios({
					...
					link.href = data;
					link.download = `territories.xlsx`; // `${this.item.file.reformat_filename}`;
					link.click();
