<template>
	<div class="content-fluid">
		<portal to="header-title">
			<span>Country</span>
			<nuxt-link tag="a" to="/countries/create" class="btn btn-primary" style="margin-left:1%;">
				<span><i class="fas fa-globe-americas"></i> Add</span>
			</nuxt-link>
		</portal>
		<div class="row">
			<div class="col-12">
	...
	data() {
		return {
			...
			columns: [
				...
				{ field: "country_name", key: "b", title: "Country", align: "left", sortBy: "" },
				{ field: "code", key: "c", title: "Code", align: "left", sortBy: "" },
				{
					field: "created_at",
					key: "d",
					title: "Created At",
					...
					renderBodyCell: ({row, column, rowIndex}, h)=> {
						return (
							<div class="btn-group btn-block">
								<button type="button" class="btn btn-warning btn-sm" on-click={()=> this.$router.push(`countries/${row['id']}/edit`)}>
			...
			this.$swal.fire({
				...
				if (result && !result.dismiss) {
					...
					try {
						...
						await this.$axios.delete(`countries/${id}`);
